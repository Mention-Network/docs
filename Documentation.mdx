...
**Mention Voyage** is a social rewards campaign designed to amplify brand discovery in the AI era. Just like Kaito, Voyage empowers you to earn **Shards** by engaging on X (formerly Twitter) with content related to **Mention Network**.

🧭 How to Earn Shards in the Mention Voyage Campaign

### 🔗 1. **Set Up Your Account**

- **Go to the Voyage Dashboard**: fractionalai.xyz/dapp/faps
- **Connect your wallet**
...
- Shards are calculated and distributed **every 1 hours**.
